...
{
    public static class GetActivityFeed
    {
        [DebuggerStepThrough]
        public class Query : IRequest<PagedQueryResult<ActivityStatsDTO>>
        {
            public Query(string userId, string startActivityId = null, string continuationToken = null)
            {
        ...
        public class Handler : IRequestHandler<Query, PagedQueryResult<ActivityStatsDTO>>
        {
            ...
            public async Task<PagedQueryResult<ActivityStatsDTO>> Handle(Query request, CancellationToken cancellationToken)
            {
            ...
            private async Task<PagedQueryResult<ActivityStatsDTO>> HandleGetActivityFeedQuery(Query request)
            {
